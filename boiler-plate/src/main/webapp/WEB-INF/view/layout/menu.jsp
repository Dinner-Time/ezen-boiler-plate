      ...
      <li class="mb-1">
        ...
        <div class="collapse" id="home-collapse">
          <ul class="btn-toggle-nav list-unstyled pb-1">
            <li
              ><a href="#" class="link-dark"><span>공통정보</span></a></li
            >
            <li
              ><a href="#" class="link-dark"><span>자재정보</span></a></li
            >
            <li
              ><a href="#" class="link-dark"><span>공정정보</span></a></li
            >
          </ul>
        </div>
        <!-- 소메뉴 -->
...
<!-- menu js -->
<script type="module" src="/resources/js/ezen/layout/menu.js" defer></script>
<!-- menu js -->
